...
const Contacts = ():JSX.Element => {
  const [activeAddressId, setActiveAddressId] = useState<AddressesType['id']>(ADDRESSES[0].id);
  const activeAddress = ADDRESSES.find((address) => address.id === activeAddressId)?.address;

  const handleClick = (id: AddressesType['id']) => {
      ...
      <div className="container">
        ...
        <div className="contacts">
          <dl className="contacts__list">
            <div className="contacts__item">
              ...
              <dd className="contacts__dd">
                <address className="contacts__address">{activeAddress}</address>
              </dd>
            </div>
            <div className="contacts__item">
          ...
          <div className="contacts__map">
            <div className="map">
              <Map locations={ADDRESSES} activeOffer={activeAddressId} onMarkerClick={handleClick}/>
            </div>
          </div>
        </div>
      </div>
