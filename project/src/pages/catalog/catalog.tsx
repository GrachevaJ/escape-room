      ...
      <div className="container">
        ...
        <div className="cards-grid">
          ...
          <div className="quest-card">
            <div className="quest-card__img">
              <picture>
                <source type="image/webp" srcSet="img/content/ritual/ritual-size-s.webp, img/content/ritual/ritual-size-s@2x.webp 2x" /><img src="img/content/ritual/ritual-size-s.jpg" srcSet="img/content/ritual/ritual-size-s@2x.jpg 2x" width="344" height="232" alt="Череп и горящая свеча в тёмном помещении." />
              </picture>
            </div>
            <div className="quest-card__content">
          ...
          <div className="quest-card">
            <div className="quest-card__img">
              <picture>
                <source type="image/webp" srcSet="img/content/ghosts/ghosts-size-s.webp, img/content/ghosts/ghosts-size-s@2x.webp 2x" /><img src="img/content/ghosts/ghosts-size-s.jpg" srcSet="img/content/ghosts/ghosts-size-s@2x.jpg 2x" width="344" height="232" alt="Силует девушки за стеклом." />
              </picture>
            </div>
            <div className="quest-card__content">
          ...
          <div className="quest-card">
            <div className="quest-card__img">
              <picture>
                <source type="image/webp" srcSet="img/content/hut/hut-size-s.webp, img/content/hut/hut-size-s@2x.webp 2x" /><img src="img/content/hut/hut-size-s.jpg" srcSet="img/content/hut/hut-size-s@2x.jpg 2x" width="344" height="232" alt="Череп животного в руках девушки." />
              </picture>
            </div>
            <div className="quest-card__content">
          ...
          <div className="quest-card">
            <div className="quest-card__img">
              <picture>
                <source type="image/webp" srcSet="img/content/experiment/experiment-size-s.webp, img/content/experiment/experiment-size-s@2x.webp 2x" /><img src="img/content/experiment/experiment-size-s.jpg" srcSet="img/content/experiment/experiment-size-s@2x.jpg 2x" width="344" height="232" alt="Производственный цех." />
              </picture>
            </div>
            <div className="quest-card__content">
          ...
          <div className="quest-card">
            <div className="quest-card__img">
              <picture>
                <source type="image/webp" srcSet="img/content/metro/metro-size-s.webp, img/content/metro/metro-size-s@2x.webp 2x" /><img src="img/content/metro/metro-size-s.jpg" srcSet="img/content/metro/metro-size-s@2x.jpg 2x" width="344" height="232" alt="Мужчина на фоне кирпичной стены." />
              </picture>
            </div>
            <div className="quest-card__content">
          ...
          <div className="quest-card">
            <div className="quest-card__img">
              <picture>
                <source type="image/webp" srcSet="img/content/loft/loft-size-s.webp, img/content/loft/loft-size-s@2x.webp 2x" /><img src="img/content/loft/loft-size-s.jpg" srcSet="img/content/loft/loft-size-s@2x.jpg 2x" width="344" height="232" alt="Фотоапарат, очки и канцелярские предметы на фоне карты." />
              </picture>
            </div>
            <div className="quest-card__content">
          ...
          <div className="quest-card">
            <div className="quest-card__img">
              <picture>
                <source type="image/webp" srcSet="img/content/frontier/frontier-size-s.webp, img/content/frontier/frontier-size-s@2x.webp 2x" /><img src="img/content/frontier/frontier-size-s.jpg" srcSet="img/content/frontier/frontier-size-s@2x.jpg 2x" width="344" height="232" alt="Застрявшая машина с надписью Help на боку." />
              </picture>
            </div>
            <div className="quest-card__content">
